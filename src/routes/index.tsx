  ...
  return (
    <section className="relative pt-32 md:pt-40 pb-20 md:pb-28 bg-gradient-hero overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <h1 className="font-serif text-[3.009375rem] sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] text-balance animate-fade-up mt-[5.125rem] md:mt-0">
  ...
  const items = [
    {
      tag: "01",
      title: "Venture Debt",
      body: "Non-dilutive growth capital from banks and non-bank venture lenders, structured to extend cash runway alongside an equity round",
    },
    {
      tag: "02",
      title: "Growth Debt",
      body: "Enterprise value and ARR-based facilities to support growth, M&A, and other strategic objectives",
    },
    {
      tag: "03",
      title: "Structured Capital & Sponsor Finance",
