  ...
  return (
    <section className="relative pt-32 md:pt-40 pb-20 md:pb-28 bg-gradient-hero overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] text-balance animate-fade-up mt-12 md:mt-0">
        ...
        <dl className="mt-28 md:mt-20 grid grid-cols-2 md:grid-cols-4 gap-5">
          {[
            ["60+", "Years Experience"],
            ["150+", "Transactions"],
