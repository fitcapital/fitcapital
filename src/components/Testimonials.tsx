    ...
    <section id="testimonials" className="py-12 lg:py-16 bg-secondary/30">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 mt-6 flex gap-3 justify-end">
        <button
          ...
          className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-border bg-card text-foreground hover:bg-primary hover:text-primary-foreground transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
        >
          <ChevronLeft size={18} />
        </button>
        <button
